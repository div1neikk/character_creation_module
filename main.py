...
def attack(char_name: str, char_class: str) -> str:
    """Wich aget u choose, that damage u give."""
...
def defence(char_name: str, char_class: str) -> str:
    """Wich agent u choose that damage u defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Wich agent u choose that damage u give with special skill."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Focus the application start dialog w player."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Focus that function choose player."""
    approve_choice: str = ''
    char_class: str = ''
